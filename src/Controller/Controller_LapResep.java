 ...
 * @author sandy
 */
public class Controller_LapResep {
    LapResep form;
    public Controller_LapResep(LapResep form){
        this.form = form;
    }
    public void awal(){
    ...
    public void cetak(){
        try{
            ...
            String path = "src/Report/LapResep.jasper";
            ...
            OutputStream output = new FileOutputStream(new File("D:/LapResep"));
