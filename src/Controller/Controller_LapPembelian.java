 ...
 * @author sandy
 */
public class Controller_LapPembelian {
        LapPembelian form;
    public Controller_LapPembelian(LapPembelian form){
        this.form = form;
    }
        public void awal(){
    ...
    public void cetak(){
        try{
            ...
            String path = "src/Report/RepLapPembelian.jasper";
            ...
            OutputStream output = new FileOutputStream(new File("D:/LapDataPembelian"));
